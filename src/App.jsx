...
function Hero() {
  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden grid-bg pt-20">
      ...
      {/* Content */}
      <div className="relative z-10 w-full px-6 max-w-7xl mx-auto flex flex-col items-center justify-center text-center">
        
        {/* Text Content */}
        <div className="flex-1 mt-12 lg:mt-0 flex flex-col items-center justify-center">
          ...
          <p className="text-base sm:text-lg text-[#5a5a72] max-w-xl mb-10 leading-relaxed" style={{ animation: 'fadeInUp 0.8s ease-out 0.45s both' }}>
